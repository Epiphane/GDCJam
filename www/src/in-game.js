...
InGame.prototype.winSequence = function() {
    ...
    var Particle = function ( id, x, y, sx, sy, cwidth, cheight ) {
        ...
        this.update = function () {
            ...
            context.fillRect(Math.floor( x - cwidthhalf ), Math.floor( y - cheighthalf ), cwidth, cheight);
    ...
    var throwCard = function ( x, y, direction ) {
        ...
        var particle = new Particle( id, x, y + cheight / 2, x, - Math.random() * 16 , cwidth, cheight);
